defmodule MegalithicWeb.Components.SVG do
  ...
  def megalith(assigns) do
    ...
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 89.3 89.3" class={"logo #{@class}"}>
      <defs>
        ...
        <clipPath id="a" transform="translate(-0.16 -0.17)">
          <circle class="a" cx="44.81" cy="44.82" r="40.02"/></clipPath>
      </defs>
      ...
      <g class="f">
        <path class="g" d="M62.94,82.34l-.2.2a.12.12,0,0,1-.14,0,9.33,9.33,0,0,1-1.47-2.1,29.33,29.33,0,0,1-1.43-2.79.5.5,0,0,1,.13-.5c.22,0,.21.19.28.32l.2.41a1.31,1.31,0,0,0,.31.71c.29.19.33.54.5.81a2.11,2.11,0,0,0,.61,1.11,8.85,8.85,0,0,0,1,1.48C62.84,82.1,63,82.19,62.94,82.34Z" transform="translate(-0.16 -0.17)"/>
        ...
        <path class="l" d="M65.35,85.61l.1.16c0-.17,0-.39.06-.45A.41.41,0,0,1,65.35,85.61Z" transform="translate(-0.16 -0.17)"/>
